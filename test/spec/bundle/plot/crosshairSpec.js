      ...
      describe('And crosshair is initialised with defaults', function () {
        ...
        plotTester.domAssertions(function(scope) {
            ...
            describe('And on obtaining the data element', function() {
              ...
              it('Then contains a horizontal wire', function() {
                expect(childElements[0].outerHTML)
                  .toEqual('<path class="horizontal wire" d="M 0 0 L 1 0"></path>');
              });

              it('Then contains a vertical wire', function() {
                expect(childElements[1].outerHTML)
                  .toEqual('<path class="vertical wire" d="M 0 0 L 0 1"></path>');
              });

              it('Then contains x annotation place holders', function() {
                expect(childElements[2].outerHTML)
                  .toEqual('<g class="axisannotation x"></g>');
              });

              it('Then contains y annotation place holders', function() {
              ...
              describe('And obtaining the root node', function() {
                ...
                describe('And obtaining the interaction rect', function() {
                  ...
                  describe('And on mouseenter', function() {
                    ...
                    it('Then it is not displayed', function() {
                      expect(g.selectAll('g.data.top').attr('display')).toBe('inline');
                    });
                    ...
                    describe('And on mousemove with valid coordinates', function() {
                      ...
                      it('Then the mouse move dispatcher is called with the right coordinates', function() {
                        expect(moveListener).toHaveBeenCalledWith(
                          [scope.plot.xScale().invert(xRange), scope.plot.yScale().invert(yRange)]
                        );
                      });
                    });
                    ...
                    describe('And on mousemove with invalid coordinates', function() {
                      ...
                      it('Then the mouse move dispatcher is called with financetime undefined, linear invert', function() {
                        expect(moveListener).toHaveBeenCalledWith(
                          [scope.plot.xScale().invert(xRange), scope.plot.yScale().invert(yRange)]
                        );
                      });
                  ...
                  describe('And on mouseout', function() {
                    ...
                    it('Then it is not displayed', function() {
                      expect(g.selectAll('g.data.top').attr('display')).toBe('none');
                    });
          ...
          plotTester.domAssertions(function(scope) {
            ...
            describe('And on obtaining the data element', function() {
              it('Then contains x annotation is populated', function() {
                expect(childElements[2].outerHTML)
                  .toEqual('<g class="axisannotation x"><g class="0"></g></g>');
              });

              it('Then contains y annotation is populated', function() {
                expect(childElements[3].outerHTML)
                  .toEqual('<g class="axisannotation y"><g class="0"></g></g>');
              });
              ...
              describe('And on mousemove', function() {
                ...
                it('Then contains x annotation is populated', function() {
                  expect(childElements[2].outerHTML)
                    .toEqual('<g class="axisannotation x"><g class="0"><g class="data" transform="translate(0,0)"><path d="M 1 0 l -4 6 l -21 0 l 0 14 l 50 0 l 0 -14 l -21 0"></path><text x="1" y="9" dy=".72em" style="text-anchor: middle;">1.0</text></g></g></g>');
                });

                it('Then contains y annotation is populated', function() {
                  expect(childElements[3].outerHTML)
                    .toEqual('<g class="axisannotation y"><g class="0"><g class="data" transform="translate(0,0)"><path d="M 1 0 l -4 6 l -21 0 l 0 14 l 50 0 l 0 -14 l -21 0"></path><text x="1" y="9" dy=".72em" style="text-anchor: middle;">1.0</text></g></g></g>');
                });
