techanModule('plot/sroc', function(specBuilder) {
  'use strict';

  var techan = require('../../../../src/techan'),
      data = require('./../_fixtures/data/sroc').plot,
      domFixtures = require('../_fixtures/dom');

  var actualInit = function() {
    return techan.plot.sroc;
  };

  specBuilder.require(techan.plot.sroc, function(instanceBuilder) {
